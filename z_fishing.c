...
static FishingFishInit sFishInits[] = {
    { 0, { 666, -45, 354 }, 71, 0.1f },    { 0, { 681, -45, 240 }, 71, 0.1f },   { 0, { 670, -45, 90 }, 71, 0.05f },
    { 0, { 615, -45, -450 }, 71, 0.2f },   { 0, { 500, -45, -420 }, 71, 0.1f },  { 0, { 420, -45, -550 }, 71, 0.05f },
    { 0, { -264, -45, -640 }, 71, 0.1f },  { 0, { -470, -45, -540 }, 71, 0.2f }, { 0, { -557, -45, -430 }, 71, 0.01f },
    { 0, { -260, -60, -330 }, 71, 0.05f }, { 0, { -500, -60, 330 }, 71, 0.06f }, { 0, { 428, -40, -283 }, 71, 0.2f },
    { 0, { 409, -70, -230 }, 71, 0.0f },   { 0, { 450, -67, -300 }, 71, 0.0f },  { 0, { -136, -65, -196 }, 71, 0.0f },
    { 1, { -561, -35, -547 }, 45, 0.0f },  { 1, { 667, -35, 317 }, 45, 0.0f },
};
...
void Fishing_Init(Actor* thisx, PlayState* play2) {
    ...
    if (thisx->params == EN_FISH_AQUARIUM) {
        ...
        this->fishLength += 4.99999f;

        // small chance to make big fish even bigger.
        if (this->fishLength >= 65.0f) {
            this->fishLength += 7.99999f;
        }
